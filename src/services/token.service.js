...
const generateEmailVerificationToken = async (user) => {
  const expires = moment().add(config.jwt.emailVerificationExpirationDays, 'days');
  const emailVerificationToken = generateToken(user.id, expires, tokenTypes.EMAIL_VERIFICATION);
